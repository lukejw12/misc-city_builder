...
execute if entity @a[predicate=untitled:movement/forward] run data modify entity @s Motion[2] set value 0.205
...
execute if entity @a[predicate=untitled:movement/backwards] run data modify entity @s Motion[2] set value -0.205
...
execute if entity @a[predicate=untitled:movement/right] run data modify entity @s Motion[0] set value -0.205
...
execute if entity @a[predicate=untitled:movement/left] run data modify entity @s Motion[0] set value 0.205
